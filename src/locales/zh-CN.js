export default {
  ...
  'menu.home': '首页',
  'menu.base': '基础页面',
  'menu.base.dashboard': 'Dashboard',
  'menu.base.dashboard.analysis': '分析页',
  'menu.base.dashboard.monitor': '监控页',
  'menu.base.dashboard.workplace': '工作台',
  'menu.base.form': '表单页',
  'menu.base.form.basicform': '基础表单',
  'menu.base.form.stepform': '分步表单',
  'menu.base.form.stepform.info': '分步表单（填写转账信息）',
  'menu.base.form.stepform.confirm': '分步表单（确认转账信息）',
  'menu.base.form.stepform.result': '分步表单（完成）',
  'menu.base.form.advancedform': '高级表单',
  'menu.base.list': '列表页',
  'menu.base.list.searchtable': '查询表格',
  'menu.base.list.basiclist': '标准列表',
  'menu.base.list.cardlist': '卡片列表',
  'menu.base.list.searchlist': '搜索列表',
  'menu.base.list.searchlist.articles': '搜索列表（文章）',
  'menu.base.list.searchlist.projects': '搜索列表（项目）',
  'menu.base.list.searchlist.applications': '搜索列表（应用）',
  'menu.base.profile': '详情页',
  'menu.base.profile.basic': '基础详情页',
  'menu.base.profile.advanced': '高级详情页',
  'menu.account': '个人页',
  'menu.account.center': '个人中心',
  'menu.account.settings': '个人设置',
  'menu.account.logout': '退出登录',
  'menu.account.trigger': '触发报错',
  'menu.base.account': '个人页',
  'menu.base.account.center': '个人中心',
  'menu.base.account.settings': '个人设置',
  'menu.base.users': '用户管理',
  'menu.base.users.usersList': '用户列表',
  'menu.other': '其它页面',
  ...
  'menu.other.components': '我的组件',
  'menu.other.components.editor': '编辑器',
  'menu.other.components.myComponents': '我的组件',
  'menu.other.components.others': '其他',
